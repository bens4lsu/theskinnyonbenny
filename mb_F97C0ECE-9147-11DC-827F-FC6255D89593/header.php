...
//********************************
//*  added by ben 03.05.2007

// START SUBST - <pun_site_menu>
$tpl_sitemenu = file_get_contents('/home/users/web/b1051/sl.theskinn/public_html/menu2.php');
$tpl_main = str_replace('<pun_site_menu>', $tpl_sitemenu, $tpl_main);
// END SUBST - <pun_site_menu>

// START SUBST - <pun_site_footer>
$tpl_sitefooter = file_get_contents('/home/users/web/b1051/sl.theskinn/public_html/indexFooter.php');
$tpl_main = str_replace('<pun_site_footer>', $tpl_sitefooter, $tpl_main);
// END SUBST - <pun_site_footer>
