...
$admin_email = 'theskinn@theskinnyonbenny.com';
...
$dbname		= 'theskinn_panel_b20';		// the name of the database
$dbhost		= 'theskinn.startlogicmysql.com';			// 99% chances you won't need to change this value
$dbusername	= 'theskinn_b20';	// your MySQL username
...
$use_bbcode = 1;	// use BBCode, like [b]bold[/b]
$use_gmcode = 1;	// use GreyMatter-styles: **bold** \italic\ __underline__
$use_quicktags = 1;	// buttons for HTML tags (they won't work on IE Mac yet)

# IMPORTANT! set this to 0 if you are using Chinese, Japanese, Korean, or other double-bytes languages
$use_htmltrans = 1;
...
$blodotgsping_url = 'http://%domaingoeshere/v-web/b2%';
