...
function pingWeblogs($blog_ID = 1) {
	...
	if ((!(($blogname=="my weblog") && ($siteurl=="http://example.com") && ($blogfilename=="b2.php"))) && (!preg_match("/theskinn.startlogicmysql.com\//",$siteurl)) && ($use_weblogsping)) {
...
function pingCafelog($cafelogID,$title='',$p='') {
	...
	if ((!(($blogname=="my weblog") && ($siteurl=="http://example.com") && ($blogfilename=="b2.php"))) && (!preg_match("/theskinn.startlogicmysql.com\//",$siteurl)) && ($use_cafelogping) && ($cafelogID != '')) {
...
function pingBlogs($blog_ID="1") {
	...
	if ((!(($blogname=='my weblog') && ($siteurl=='http://example.com') && ($blogfilename=='b2.php'))) && (!preg_match('/theskinn.startlogicmysql.com\//',$siteurl)) && ($use_blodotgsping)) {
