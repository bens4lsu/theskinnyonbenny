...
if (count($files) > 0) {
	...
	echo "window.location=\"https://theskinnyonbenny.com/dailyphoto/2017/page.php?year=".$year."&month=".$month."&day=".$day."\"";
}
else {
	//there are no photos for this year yet
	echo "window.location=\"https://theskinnyonbenny.com/dailyphoto/index.php";
